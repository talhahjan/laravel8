...
@section('title', 'Admin dashboard :: Add Section')

@section('breadcrumbs')
<li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
<li class="breadcrumb-item"><a href="{{route('admin.section.index')}}">Sections</a></li>
...
<section class="content" style="padding:20px">
    <div class="container-fluid">
        ...
        <div id="accordion">
            <!-- form start -->
            <form action="{{route('admin.section.update', $section->slug)}}" method="post" name="form-example-1" id="form-example-1" enctype="multipart/form-data">
                @csrf
                @METHOD('PUT')
                <!-- card common start -->
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control" value="{{$section->title}}" placeholder="Section Title">
                                        <p class="small">{{config('app.url')}}<span id="url">{{$section->slug}}</span></p>
                                        <input type="hidden" name="slug" id="slug" value="{{$section->slug}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option value="1" {{$section->status ? ' selected': ''}}>Visible</option>
                                            <option value="0" {{$section->status ? '': ' selected'}}>Invisible</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div id="collapseBanner" class="collapse" aria-labelledby="Banner" data-parent="#accordion">
                        <div class="card-body">
                            <div class="input-group mb-3">
                                ...
                                @isset($section->banner)
                                <div class="row">
                                    <div class="text-center" id="thumbnail">
                                        <img id="blah" class="img-thumbnail" src="{{asset($section->banner)}}" alt="your image">
                                        <a href="#" id="btn-del" class="btn btn-danger btn-sm" onclick="confirmDelete({{$section->id}})"><i class="fa fa-trash"></i></a>
                                    </div>
                                </div>
                                @endisset

                                @empty($section->banner)
                                <div id="thumbnail">
