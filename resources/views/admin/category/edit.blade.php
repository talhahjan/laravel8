...
<section class="content">
  <div class="container-fluid">
    ...
    <div id="accordion">
      <!-- form start -->
      <form action="{{route('admin.category.update', $category->slug)}}" method="post" name="form-example-1" id="form-example-1" enctype="multipart/form-data">
        @csrf
        @METHOD('PUT')
        <!-- card common start -->
        <div class="card">
...
<option value="{{$section->id}}"{{$category->section_id==$section->id ? " selected": ""}}>{{$section->title}}</option>
@endforeach
</select>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control" value="{{$category->title}}" placeholder="Enter Title">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select type="text" name="status" class="form-control" id="status">
                      <option value="1" {{$category->status==0 ? ' selected': ''}}>Visible</option>
                      <option value="0" {{$category->status==1 ? ' selected': ''}}>Invisible</option>
                    </select>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="text-center" id="thumbnail">
                  <img id="blah" class="img-thumbnail" src="{{asset($category->banner)}}" alt="your image">
                  <a href="#" id="btn-del" class="btn btn-danger btn-sm" onclick="confirmDelete({{$category->id}})"><i class="fa fa-trash"></i></a>
                </div>
              </div>
              @endisset
...
<script src="{{asset('assets/admin_plugins/bootstrap-notify/notify.js')}}"></script>
