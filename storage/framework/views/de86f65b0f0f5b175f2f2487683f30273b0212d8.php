<?php $__env->startSection('title', 'Admin dashboard :: Add Category'); ?>
...
<section class="content">
  <div class="container-fluid">
    ...
    <div id="accordion">
      <!-- form start -->
      <form action="<?php echo e(route('admin.category.store')); ?>" method="post" name="form-example-1" id="form-example-1" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <!-- card common start -->
        <div class="card">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webserver\www\l8ecom\resources\views/admin/category/create.blade.php ENDPATH**/ ?>