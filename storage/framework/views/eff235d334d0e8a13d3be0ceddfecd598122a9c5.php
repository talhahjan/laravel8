...
<section class="content" style="padding:20px;">
  <div class="container-fluid">
    ...
    <div id="accordion">
      <!-- form start -->
      <form action="<?php echo e(route('admin.section.store')); ?>" method="post" name="form-example-1" id="form-example-1" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <!-- card common start -->
        <div class="card">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <p class="small"><?php echo e(config('app.url')); ?><span id="url"></span></p>
        ...
        <div>
          <button type="submit" type="submit" class="btn btn-block btn-outline-primary"><i class="fas fa-plus-circle"></i> Add Section</button>
        </div>
      </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webserver\www\l8ecom\resources\views/admin/sections/create.blade.php ENDPATH**/ ?>