...
<head>
  ...
  <!-- font awesome  -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/css/fontawsome-all.css.css')); ?>" />
<!-- OwlCarousel css File -->
<link rel="stylesheet" href="<?php echo e(asset('assets/css/owlcarousel/owl.carousel.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/css/owlcarousel/owl.theme.default.min.css')); ?>">
 <!-- start rating Css -->
<link rel="stylesheet" href="<?php echo e(asset('assets/admin_plugins/star-rating/star-rating.css')); ?>">
...
<i class="fa fa-bars"></i>
        ...
        <a class="navbar-brand" href="#"><img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt=""></a>
...
<div class="avatar">
<img src="<?php echo e(@Auth::user()->profile->avatar ? asset(@Auth::user()->profile->avatar) : asset('assets/admin_img/user2-160x160.jpg')); ?>" alt="profile Pic" class="rounded-circle img-thumbnai" style="height: 50px; width:50x; margin-right: 10px">
</div>

<div class="align-self-center">
<h6><?php echo e(@Auth::user()->profile->first_name .' ' .@Auth::user()->profile->last_name); ?></h6>
</div>
...
<script src="<?php echo e(asset('assets/js/bootstrap/bootstrap.bundle.js')); ?>" crossorigin="anonymous"></script>
<!-- Jquery js file -->
<script src="<?php echo e(asset('assets/js/jquery/jquery-3.5.1.min.js')); ?>"></script>
<!-- jQuery Plugins OwlCarousel  -->
<script src="<?php echo e(asset('assets/js/jquery/plugins/owl.carousel.js')); ?>"></script>
<!-- star rating Js File  -->
<script src="<?php echo e(asset('assets/admin_plugings/star-rating/star-rating.min.js')); ?>"></script>
<script>
  
  <?php echo $__env->yieldContent('JSript'); ?>
...
<?php /**PATH D:\webserver\www\l8ecom\resources\views/layouts/User/app.blade.php ENDPATH**/ ?>